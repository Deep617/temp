...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _loadStreak() async {
    final data = await strikeRepository.getStrikeStreak(widget.buddyId);
    setState(() {
      _streak = data['streak'] as int;
    });
    // AppBar title: "Rahul  🔥5"
  }
          ...
          actions: [
            IconButton(
              ...
              onPressed: () async {
                ...
                final url = await strikeRepository.uploadFile(image.path);

                // Then send strike
                var response = await strikeRepository.sendStrike(
                  matchId: widget.buddyId,
                  imageUrl: url,

...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    if (widget.matchId != null) {
      context.read<StrikeBloc>().add(StrikeLoadRequested(
          ...
          Scaffold(
            ...
            appBar: AppBar(
              ...
              title: GestureDetector(
                onTap: () =>
                    context.push(
                        AppRoutes.buddyProfile.replaceAll(
                      ...
                      builder: (_, state) =>
                          Text(
                            ...
                            style: AppTextStyles.caption(
                                color: _isTyping ? AppColors.primary : AppColors
                                    .textMuted),
                          ),
                    ),
                  ]),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          const Icon(
                              Icons.fitness_center, color: AppColors.primary,
                              size: 14),
                        ...
                        builder: (context, state) =>
                            TextField(
                              ...
                              onChanged: (v) {
                                ...
                                _socket?.emit(
                                    'typing:start', {'chatId': widget.chatId});
...
class _SessionInviteCardState extends State<_SessionInviteCard> {
  ...
  Future<void> _respond(String action) async {
    ...
    try {
      ...
      await _sessionRepository.respondToSessionInvite(sessionId, action);
      if (mounted) {
        setState(() {
          _responding     = false;
...
class _StrikePreviewSheet extends StatefulWidget {
  ...
  @override
  State<_StrikePreviewSheet> createState() =>
      _StrikePreviewSheetState();
}

class _StrikePreviewSheetState
    extends State<_StrikePreviewSheet> {
  ...
  Future<void> _send() async {
    ...
    try {
      ...
      context.read<StrikeBloc>().add(StrikeSendRequested(
        matchId:    widget.matchId,
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Strike sent to ${widget.buddyName}! ⚡'),
